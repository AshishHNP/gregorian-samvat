...
public class OldHinduLunar extends Date
{
    ...
    public static long toFixed(long year, int month, boolean leapMonth, int day)
    {
        ...
        return (long)Math.floor((double)OldHinduSolar.EPOCH + lunarNewYear + 29.530581807581694D * (double)(!leapMonth && Math.ceil((lunarNewYear - mina) / 0.90764157204793605D) <= (double)month ? month : month - 1) + (double)(day - 1) * 0.9843527269193898D + 0.75D);
    }
    ...
    {
        return mod((double)lYear * 365.25868055555554D - 30.43822337962963D, 29.530581807581694D) >= 18.638882943006465D;
    }

    protected String toStringFields()
    {
        return (new StringBuilder("year=")).append(year).append(",month=").append(month).append(",leapMonth=").append(leapMonth).append(",day=").append(day).toString();
    }

    public String format()
    {
        return MessageFormat.format("{0}, {1} {2}{3} {4,number,#} K.Y.", new Object[] {
            nameFromDayOfWeek(toFixed(), dayOfWeekNames), new Integer(day), nameFromMonth(month, monthNames), leapMonth ? " II" : "", new Long(year)
        });
    }
    ...
    public static final String dayOfWeekNames[] = {
        "Ravivaar", "Somvaar", "Mangalvaar", "Budhvaar", "Guruvaar", "Shukrvaar", "Shanivaar"
    };
    public static final String gujaratiWeekNames[] = {
        "\u0AB0\u0AB5\u0ABF\u0AB5\u0ABE\u0AB0", "\u0AB8\u0ACB\u0AAE\u0AB5\u0ABE\u0AB0", "\u0AAE\u0A82\u0A97\u0AB3\u0AB5\u0ABE\u0AB0", "\u0AAC\u0AC1\u0AA7\u0AB5\u0ABE\u0AB0", "\u0A97\u0AC1\u0AB0\u0AC1\u0AB5\u0ABE\u0AB0", "\u0AB6\u0AC1\u0A95\u0ACD\u0AB0\u0AB5\u0ABE\u0AB0", "\u0AB6\u0AA8\u0ABF\u0AB5\u0ABE\u0AB0"
    };
    public static final String monthNames[] = {
        "Chaitra", "Vaishakh", "Jeth", "Ashadha", "Shravan", "Bhadarvaa", "Aaso", "Kartak", "Magshar", "Posh", 
        "Maha", "Faagan"
    };
    public static final String gujaratiMonthNames[] = {
        "\u0A9A\u0AC8\u0AA4\u0ACD\u0AB0", "\u0AB5\u0AC8\u0AB6\u0ABE\u0A96", "\u0A9C\u0AC7\u0AA0", "\u0A85\u0AB7\u0ABE\u0AA2", "\u0AB6\u0ACD\u0AB0\u0ABE\u0AB5\u0AA3", "\u0AAD\u0ABE\u0AA6\u0AB0\u0AB5\u0ACB", "\u0A86\u0AB8\u0ACB", "\u0A95\u0ABE\u0AB0\u0AA4\u0A95", "\u0AAE\u0ABE\u0A97\u0AB6\u0AB0", "\u0AAA\u0ACB\u0AB7", 
        "\u0AAE\u0AB9\u0ABE", "\u0AAB\u0ABE\u0A97\u0AA3"
    };
